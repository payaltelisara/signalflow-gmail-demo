...
function setView(view) {
  ...
  const [title, subtitle] = content[view] || content.overview; $('#pageTitle').textContent = title; $('#pageSubtitle').textContent = subtitle; document.body.classList.toggle('campaigns-active', view === 'campaigns'); $$('[data-view]').forEach(link => link.classList.toggle('active', link.dataset.view === view));
